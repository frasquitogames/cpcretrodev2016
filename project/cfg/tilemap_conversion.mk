...
$(eval $(call TMX2C,assets/pp.tmx,g_nivel_pp,src/niveles))
$(eval $(call TMX2C,assets/ciudadanos.tmx,g_nivel_ciudadanos,src/niveles))
$(eval $(call TMX2C,assets/psoe.tmx,g_nivel_psoe,src/niveles))
$(eval $(call TMX2C,assets/podemos.tmx,g_nivel_podemos,src/niveles))
$(eval $(call TMX2C,assets/sedes.tmx,g_nivel_sedes,src/niveles))

$(eval $(call TMX2C,assets/hud.tmx,g_hud,src/sprites))
