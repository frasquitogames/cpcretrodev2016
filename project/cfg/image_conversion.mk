...
$(eval $(call IMG2SPRITES,assets/tiles.png,0,g,8,8,$(PALETTE),tileset,src/tiles/,hwpalette))

$(eval $(call IMG2SPRITES,assets/rajoy.png,0,g,8,8,$(PALETTE),,src/characters,))
$(eval $(call IMG2SPRITES,assets/albert.png,0,g,8,8,$(PALETTE),,src/characters,))
$(eval $(call IMG2SPRITES,assets/susana.png,0,g,8,8,$(PALETTE),,src/characters,))
$(eval $(call IMG2SPRITES,assets/pablo.png,0,g,8,8,$(PALETTE),,src/characters,))

$(eval $(call IMG2SPRITES,assets/objetos.png,0,g,8,8,$(PALETTE),,src/objects,))

$(eval $(call IMG2SPRITES,assets/banquero.png,0,g,8,8,$(PALETTE),,src/characters,))
$(eval $(call IMG2SPRITES,assets/fan.png,0,g,8,8,$(PALETTE),,src/characters,))
$(eval $(call IMG2SPRITES,assets/policia.png,0,g,8,8,$(PALETTE),,src/characters,))

$(eval $(call IMG2SPRITES,assets/fondo.png,0,g,80,100,$(PALETTE),,src/sprites,))

$(eval $(call IMG2SPRITES,assets/pp.png,0,g,40,20,$(PALETTE),,src/sprites,))
$(eval $(call IMG2SPRITES,assets/ciudadanos.png,0,g,40,20,$(PALETTE),,src/sprites,))
$(eval $(call IMG2SPRITES,assets/psoe.png,0,g,40,20,$(PALETTE),,src/sprites,))
$(eval $(call IMG2SPRITES,assets/podemos.png,0,g,40,20,$(PALETTE),,src/sprites,))

$(eval $(call IMG2SPRITES,assets/tres.png,0,g,16,16,$(PALETTE),,src/sprites,))
$(eval $(call IMG2SPRITES,assets/dos.png,0,g,16,16,$(PALETTE),,src/sprites,))
$(eval $(call IMG2SPRITES,assets/uno.png,0,g,16,16,$(PALETTE),,src/sprites,))